<h2 style="margin-left: 13%;">Aceita Jesus<h2/>
    ...
    <span style="font-size:15px; color: #666666; margin-left: 1.3%;">
        Eu aceito Jesus Cristo como único e suficiente Salvador e o declaro como Senhor da minha vida.
    </span>
    <form id="contact" name="formAceitaJesus" onsubmit="return validaAceitaJesus();" action="aceitaJesus.php" method="post">
        <fieldset>
            <div style="margin-left: -24.8%; width: 10px;">
                <input 	type="checkbox" 
