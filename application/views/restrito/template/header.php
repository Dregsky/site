<head>
    ...
    <link rel="stylesheet" href="<?= base_url('public/css/restrito/template/skins/_all-skins.min.css') ?>" >
    <!-- iCheck -->
    <link rel="stylesheet" href="<?= base_url('public/plugins/iCheck/flat/flat.css') ?>">
    <!-- Morris chart -->
    ...
    <!-- FastClick -->
    <script type="text/javascript" src="<?= base_url('public/js/plugins/fastclick/fastclick.min.js') ?>"></script>
    <!-- AdminLTE App -->
