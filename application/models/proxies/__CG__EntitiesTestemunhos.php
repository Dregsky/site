 ...
 */
class Testemunhos extends \Entities\Testemunhos implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::getNomeTestemunho();
    }
    ...
    {
        $this->__load();
        return parent::setNomeTestemunho($nomeTestemunho);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'nomePessoa', 'nomeTestemunho', 'descricao', 'dataCadastro', 'dataExclusao', 'status');
    }
