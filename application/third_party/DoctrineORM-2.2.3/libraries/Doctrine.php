...
// Set up class loading. You could use different autoloaders, provided by your favorite framework,
        // if you want to.
        require_once APPPATH . 'third_party/DoctrineORM-2.2.3/libraries/Doctrine/Common/ClassLoader.php';
        require_once APPPATH . "third_party/DoctrineORM-2.2.3/libraries/Doctrine/ORM/Tools/Setup.php";
